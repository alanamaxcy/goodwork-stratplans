/* Demo engagement, plan and workplan.
...
export const PORTAL = {
 ...
 "plan": {
  ...
  "priorities": [
   ...
   },
   {
    "id": "P3",
    "n": 3,
    "title": "A church of Cedar Hollow",
    ...
    "initiatives": [
     ...
     },
     {
      ...
      "detail": "Space limits came up 18 times, and Cedar Hollow Plaza is changing around us (16 sources). Stay, expand, or share — decide it, on evidence, by mid-2027, so the rest of the plan can assume an answer.",
      "evidence": [
       "w8",
       "t3",
       "o2"
 ...
 "tasks": [
  ...
  },
  {
   "id": "T-301",
   "obj": "3.1",
   "title": "Map organizations already working in Cedar Hollow",
   "owner": "D. Castellanos",
   "start": "2026-08-24",
   "due": "2026-09-25",
   "status": "doing"
